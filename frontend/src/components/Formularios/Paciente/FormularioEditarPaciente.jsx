...
const FormularioEditarPaciente = ({ paciente, cerrarForm }) => {
  const [foto, setFoto] = useState(null)
  const [loading, setLoading] = useState(false)
  const formRef = useRef(null)
  const { putPaciente } = usePaciente()
  ...
  const submitEditar = async (e) => {
    ...
    await putPaciente(paciente._id, nuevoUsuario)
    cerrarForm()
    setLoading(false)
  }
  ...
  return (
    <form className='formEditarPaciente' onSubmit={submitEditar} ref={formRef}>
      <div className='input'>
        ...
        <BotónSecundario tipo={'button'} onClickFunction={cerrarForm} texto={`Cerrar`} />
      </div>
      ...
      <div className='input'>
        ...
        <input type='date' name='fechaDeNac' defaultValue={paciente.fechaDeNac} />
      </div>
      ...
      <div className='input'>
        ...
        <input type='text' name='observaciones' defaultValue={paciente.observaciones} />
      </div>
      ...
      <div className='input'>
        ...
        <input type='text' name='circulatorio' defaultValue={paciente.circulatorio} />
      </div>
      ...
      <div className='input'>
        ...
        <input type='text' name='operaciones' defaultValue={paciente.operaciones} />
      </div>

      <div className='input'>
        <label>Enfermedades oncológicas</label>
        <input type='text' name='oncologicas' defaultValue={paciente.oncologicas} />
      </div>

      <div className='input'>
        <label>Otras enfermedades</label>
        <input type='text' name='enfermedades' defaultValue={paciente.enfermedades} />
      </div>

      <div className='input'>
        <label>Medicamentos</label>
        <input type='text' name='medicamentos' defaultValue={paciente.medicamentos} />
      </div>
