...
import './PorcentajesComponent.scss' // Importa el archivo CSS para las animaciones

function calcularPorcentajes(datos) {
	const total = Object.values(datos).reduce(
	...
	const porcentajesArray = Object.entries(porcentajes).map(
